  ...
  return (
    <div className="card">
        ...
        <div className="card___wrapper-acounts">
          ...
          <div className="card__acounts">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
              ...
              <path
                style={{ fill: "none", strokeLinecap: "round", strokeLinejoin: "round", stroke: "#515570", strokeWidth: 2, opacity: 0.2 }}
          ...
          <div className="card__acounts">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
              ...
              ></path>
              <path
                style={{ fill: "none", strokeLinecap: "round", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: 2, opacity: 0.1 }}
      ...
      <div className="card__indicator">
        <span className="card__indicator-amount">135</span> Works / <span className="card__indicator-percentage">45%</span>
      </div>
