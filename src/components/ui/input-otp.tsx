...
import { cn } from "../../utils/helpers/shadcnHelper";
  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative flex h-9 w-9 items-center justify-center border text-sm  transition-all first:rounded-l-md  last:rounded-r-md",
